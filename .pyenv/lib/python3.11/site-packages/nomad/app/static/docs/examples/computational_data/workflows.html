...
">
        ...
        <link rel="prev" href="uploading.html">
      
      
        <link rel="next" href="metainfo.html">
   ...
   <link href="../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#standard-and-custom-computational-workflows-in-nomad" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="uploading.html" class="md-nav__link">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#automatic-workflows" class="md-nav__link">
    ...
    <li class="md-nav__item">
      <a href="metainfo.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="schema_plugins.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="parser_plugins.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="h5md_howto.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="h5md_expl.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="h5md_ref.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/nexus.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/pynxtools.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/em.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/mpes.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/xps.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/opt.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/apm.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="../experiment_data/sts.html" class="md-nav__link">
...
<h1 id="standard-and-custom-computational-workflows-in-nomad">Standard and Custom Computational Workflows in NOMAD<a class="headerlink" href="#standard-and-custom-computational-workflows-in-nomad" title="Permanent link">&para;</a></h1>
<p>The following examples contain the basic knowledge on understanding and learning to use NOMAD workflows, and its relation with DFT and beyond-DFT (GW, BSE, DMFT, etc.) methodologies. You will use a fictitious example of a simulation workflow with the following files and folder structure:
...
<p>which can be downloaded here:
<center>
<a class="md-button nomad-button" href="data/example_files.zip">Download example_files.zip</a>
</center></p>
<p>Each of the <em>mainfiles</em> represent an electronic-structure calculation (either <a href="https://en.wikipedia.org/wiki/Density_functional_theory">DFT</a>{:target="<em>blank"}, <a href="https://en.wikipedia.org/wiki/Tight_binding" target="_blank">TB</a>, or <a href="https://en.wikipedia.org/wiki/Dynamical_mean-field_theory" target="_blank">DMFT</a>) which in turn is then parsed into a singular _entry</em> in NOMAD. When dragged into the <a href="https://nomad-lab.eu/prod/v1/staging/gui/user/uploads">NOMAD Upload page</a>{:target="<em>blank"}, these files should generate 8 entries in total. This folder structure presents a typical workflow calculation which can be represented as a provenance graph:
<pre class="mermaid"><code>graph LR;
    ...
    D12[DMFT at T2] --&gt; E12([Output calculation P1, T2])</code></pre>
Here, "Input" refers to the all _input</em> information given to perform the calculation (e.g., atom positions, model parameters, experimental initial conditions, etc.). "DFT", "TB" and "DMFT" refer to individual <em>tasks</em> of the workflow, which each correspond to a <em>SinglePoint</em> entry in NOMAD. "Output calculation" refers to the <em>output</em> data of each of the final DMFT tasks.</p>
<p>The goal of this part is to set up the following workflows:</p>
<ol>
...
<p>The files for all these cases can be downloaded here:
<center>
<a class="md-button nomad-button" href="data/workflowyaml_files.zip">Download worfklowyaml_files.zip</a>
</center></p>
<p>You can try writing these files yourself first, and then compare them with the tested files.</p>
...
<p>NOMAD is able to recognize certain workflows in an automatic way, such as the <code>SinglePoint</code> case mentioned above. However, to showcase how to the use workflows in NOMAD, you will learn how to "manually" construct the SinglePoint workflow, represented by the following provenance graph:
<pre class="mermaid"><code>graph LR;
    A((Inputs)) --&gt; B[DFT];
    B[DFT] --&gt; C([Output calculation]);</code></pre>
...
<a id="__codelineno-1-10" name="__codelineno-1-10" href="#__codelineno-1-10"></a><span class="w">    </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="nt">m_def</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">nomad.datamodel.metainfo.workflow.TaskReference</span>
...
<p><a class="glightbox" href="images/singlepoint.png" data-type="image" data-width="auto" data-height="auto" data-desc-position="bottom"><img alt="NOMAD workflow schema" class="screenshot" src="images/singlepoint.png" /></a></p>
...
<p class="admonition-title">NOMAD workflow filename</p>
<p>The NOMAD workflow YAML file name, i.e., <code>&lt;filename&gt;</code> in the explanation above, can be any custom name defined by the user, but the file <strong>must</strong> keep the extension <code>.archive.yaml</code> at the end. This is done in order for NOMAD to recognize this file as a <em>custom schema</em>. Custom schemas are widely used in experimental parsing, and you can learn more about them in the <a href="https://www.fairmat-nfdi.eu/events/fairmat-tutorial-8/tutorial-8-home">FAIRmat tutorial 8</a>.</p>
</div>
<p>You can extend the workflow meta-information by adding the metholodogical input parameters. These are stored in NOMAD in the section path <code>run[0].method[-1]</code>. The new <code>single_point.archive.yaml</code> will be:</p>
...
<a id="__codelineno-2-12" name="__codelineno-2-12" href="#__codelineno-2-12"></a><span class="w">    </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="nt">m_def</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">nomad.datamodel.metainfo.workflow.TaskReference</span>
...
<p><a class="glightbox" href="images/singlepoint_methodadded.png" data-type="image" data-width="auto" data-height="auto" data-desc-position="bottom"><img alt="SinglePoint workflow visualizer with Method added" class="screenshot" src="images/singlepoint_methodadded.png" /></a></p>
<h2 id="pressure-workflows">Pressure workflows<a class="headerlink" href="#pressure-workflows" title="Permanent link">&para;</a></h2>
<p>Now that you know the basics of the workflow YAML schema, let's try to define an overarching workflow for each of the pressures. For this section, you will learn how to create the workflow YAML schema for the P<sub>1</sub> case; the extension for P<sub>2</sub> is then a matter of changing names and paths in the YAML files. For simplicity, you can skip referencing to methodologies.</p>
...
<p><a class="glightbox" href="images/pressure1.png" data-type="image" data-width="auto" data-height="auto" data-desc-position="bottom"><img alt="Pressure P1 workflow visualizer" class="screenshot" src="images/pressure1.png" /></a></p>
...
In order to define the general workflow that groups all pressure calculations, YOU can reference directly the previous <code>pressureX.archive.yaml</code> files as tasks. Still, <code>inputs</code> and <code>outputs</code> must be referenced to their corresponding mainfile and section paths.</p>
...
<p><a class="glightbox" href="images/fullworkflow.png" data-type="image" data-width="auto" data-height="auto" data-desc-position="bottom"><img alt="Full workflow visualizer" class="screenshot" src="images/fullworkflow.png" /></a></p>
...
<ul>
<li>Always organize your files in an <strong>top-down structure</strong>, i.e., the initial <em>tasks</em> should be upper in the directory tree, while the later <em>tasks</em> lower on it.</li>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="uploading.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Quick start">
          ...
          <a href="metainfo.html" class="md-footer__link md-footer__link--next" aria-label="Next: MetaInfo">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
