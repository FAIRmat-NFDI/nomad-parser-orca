...
">
        ...
        <link rel="next" href="schema_plugins.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>MetaInfo - Documentation</title>
   ...
   <link href="../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#guide-to-computational-metainfo" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    MetaInfo
      ...
      <a href="metainfo.html" class="md-nav__link md-nav__link--active">
...
<h1 id="guide-to-computational-metainfo">Guide to Computational MetaInfo<a class="headerlink" href="#guide-to-computational-metainfo" title="Permanent link">&para;</a></h1>
...
<h3 id="overview-of-metadata-organization-for-computation">Overview of metadata organization for computation<a class="headerlink" href="#overview-of-metadata-organization-for-computation" title="Permanent link">&para;</a></h3>
...
The schema that defines the organization of (meta)data within the archive is known as the <a href="../../reference/glossary.html#metainfo">MetaInfo</a>. See <a href="../../explanation/data.html">Explanation &gt; Data structure</a> for general information about data structures and schemas in NOMAD.</p>
<p>The following diagram is an overarching visualization of the most important archive sections for computational data:</p>
...
<a id="__codelineno-0-18" name="__codelineno-0-18" href="#__codelineno-0-18"></a>└── workflow2
...
<code>system</code> stores attributes of the atoms involved in the calculation, e.g., atom types, positions, lattice vectors, etc. <code>calculation</code> stores the output of the calculation, e.g., energy, forces, etc.</p>
...
simulation would be stored under <code>workflow/results</code>. Then, the <code>inputs</code>, <code>outputs</code>, and <code>tasks</code> sections define the specifics of the workflow.
For some standard workflows, e.g., geometry optimization and molecular dynamics, the NOMAD <a href="../../explanation/processing.html#normalizing">normalizers</a>
...
See <a href="workflows.html">Standard and Custom Computational Workflows in NOMAD</a> for more information about the structure of the workflow section, as well as instructions on how to upload custom workflows to link individual Entries in NOMAD.</p>
...
<p>We are currently performing a complete refactoring of the computational MetaInfo schema. Details and updates about this task, and how it may benefit your future usage of NOMAD, will be added below.</p>
</div>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="workflows.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Workflows">
          ...
          <a href="schema_plugins.html" class="md-footer__link md-footer__link--next" aria-label="Next: Schema plugins">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
