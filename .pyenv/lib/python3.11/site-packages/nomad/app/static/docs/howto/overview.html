...
">
        ...
        <link rel="prev" href="../tutorial/develop_plugin.html">
      
      
        <link rel="next" href="manage/upload.html">
   ...
   <link href="../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#nomad-how-to-guides" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#users" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Users">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#manage-and-find-data" class="md-nav__link">
    <span class="md-ellipsis">
      Manage and find data
          ...
          <li class="md-nav__item">
  <a href="#programmatic-use" class="md-nav__link">
    <span class="md-ellipsis">
      Programmatic use
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#data-stewards-administrators-and-developers" class="md-nav__link">
    <span class="md-ellipsis">
      Data stewards, administrators, and developers
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Data stewards, administrators, and developers">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#nomad-oasis" class="md-nav__link">
    <span class="md-ellipsis">
      NOMAD Oasis
    </span>
  </a>
...
<h1 id="nomad-how-to-guides">NOMAD How-to guides<a class="headerlink" href="#nomad-how-to-guides" title="Permanent link">&para;</a></h1>
<h2 id="users">Users<a class="headerlink" href="#users" title="Permanent link">&para;</a></h2>
<p>These how-to guides target NOMAD users and cover data management, exploration, analysis with NOMAD graphical web-interface and APIs.</p>
<div class="home-grid">
<div>
<h3 id="manage-and-find-data">Manage and find data<a class="headerlink" href="#manage-and-find-data" title="Permanent link">&para;</a></h3>
<p>Use NOMAD to manage, explore, and analyze data.</p>
<ul>
<li><a href="manage/upload.html">Upload and publish data for supported formats</a></li>
<li><a href="manage/eln.html">Use ELNs</a></li>
<li><a href="manage/explore.html">Explore data</a></li>
<li><a href="manage/north.html">Use NORTH</a></li>
</ul>
</div>
<div>
<h3 id="programmatic-use">Programmatic use<a class="headerlink" href="#programmatic-use" title="Permanent link">&para;</a></h3>
<p>Use NOMAD's functions programmatically and via its APIs.</p>
<ul>
<li><a href="programmatic/api.html">Use the API</a></li>
<li><a href="programmatic/publish_python.html">Publish data using python</a></li>
<li><a href="programmatic/pythonlib.html">Install nomad-lab</a></li>
<li><a href="programmatic/archive_query.html">Access processed data</a></li>
<li><a href="programmatic/local_parsers.html">Run a parser</a></li>
</ul>
</div>
</div>
<h2 id="data-stewards-administrators-and-developers">Data stewards, administrators, and developers<a class="headerlink" href="#data-stewards-administrators-and-developers" title="Permanent link">&para;</a></h2>
<p>These how-to guides allow advanced users, NOMAD administrators, data stewards, and developers to customize and operate NOMAD and NOMAD Oasis or contribute to NOMAD's development.</p>
<div class="home-grid">
<div>
<h3 id="nomad-oasis">NOMAD Oasis<a class="headerlink" href="#nomad-oasis" title="Permanent link">&para;</a></h3>
<p>Host NOMAD for your lab or institution.</p>
<ul>
<li><a href="oasis/install.html">Install an Oasis</a></li>
<li><a href="oasis/customize.html">Customize an Oasis</a></li>
<li><a href="oasis/plugins_install.html">Install plugins</a></li>
<li><a href="oasis/migrate.html">Migrate Oasis versions</a></li>
<li><a href="oasis/admin.html">Administrate and maintain an Oasis</a></li>
</ul>
</div>
<div>
<h3 id="customization">Customization<a class="headerlink" href="#customization" title="Permanent link">&para;</a></h3>
<p>Customize NOMAD, write plugins, and tailor NOMAD Oasis.</p>
<ul>
<li><a href="customization/basics.html">Write a schema</a></li>
<li><a href="customization/elns.html">Define ELNs</a></li>
<li><a href="customization/base_sections.html">Use base sections</a></li>
<li><a href="customization/tabular.html">Parse tabular data</a></li>
<li><a href="customization/workflows.html">Define workflows</a></li>
<li><a href="plugins/plugins.html">Write plugins</a></li>
<li><a href="plugins/apps.html">Write an app</a></li>
<li><a href="plugins/normalizers.html">Write a normalizer</a></li>
<li><a href="plugins/parsers.html">Write a parser</a></li>
<li><a href="plugins/schema_packages.html">Write a schema packages</a></li>
<li><a href="customization/units.html">Work with units</a></li>
<li><a href="customization/hdf5.html">Use HDF5 to handle large quantities</a></li>
</ul>
</div>
<div>
<h3 id="development">Development<a class="headerlink" href="#development" title="Permanent link">&para;</a></h3>
<p>Become a NOMAD developer and contribute to the source code.</p>
<ul>
<li><a href="develop/setup.html">Get started</a></li>
<li><a href="develop/code.html">Navigate the code</a></li>
<li><a href="develop/contrib.html">Contribute</a></li>
<li><a href="develop/search.html">Extend the search</a></li>
</ul>
</div>
</div>
<h2>One last thing</h2>

<p>If you can't find what you're looking for in our guides, <a href="mailto:support@nomad-lab.eu">contact our team</a> for personalized help and assistance. Don't worry, we're here to help and learn what we're doing wrong!</p>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="../tutorial/develop_plugin.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Developing a NOMAD plugin">
          ...
          <a href="manage/upload.html" class="md-footer__link md-footer__link--next" aria-label="Next: Upload and publish data for supported formats">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
