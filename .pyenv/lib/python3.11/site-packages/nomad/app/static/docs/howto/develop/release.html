...
">
        ...
        <link rel="prev" href="migrate-to-autoformatter.html">
      
      
        <link rel="next" href="../../examples/overview.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Make a release - Documentation</title>
   ...
   <link href="../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#how-to-release-a-new-nomad-version" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="migrate-to-autoformatter.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    Make a release
      ...
      <a href="release.html" class="md-nav__link md-nav__link--active">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#what-is-a-release" class="md-nav__link">
    <span class="md-ellipsis">
      What is a release
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#steps-towards-a-new-release" class="md-nav__link">
    <span class="md-ellipsis">
      Steps towards a new release
        ...
        <li class="md-nav__item">
  <a href="#how-to-deal-with-hotfixes" class="md-nav__link">
    <span class="md-ellipsis">
      How to deal with hotfixes
        ...
        <li class="md-nav__item">
  <a href="#major-minor-patch-versions" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="how-to-release-a-new-nomad-version">How to release a new NOMAD version<a class="headerlink" href="#how-to-release-a-new-nomad-version" title="Permanent link">&para;</a></h1>
<h2 id="what-is-a-release">What is a release<a class="headerlink" href="#what-is-a-release" title="Permanent link">&para;</a></h2>
<p>NOMAD is a public service, a Git repository, a Python package, and a docker image.
What exactly is a NOMAD release? It is all of the following:</p>
<ul>
<li>a version tag on the main NOMAD <a href="https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR">git project</a>,
e.g. <a href="https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/tags/v1.3.0"><code>v1.3.0</code></a></li>
<li>a gitlab release based on a tag with potential release notes</li>
<li>a version of the <code>nomad-lab</code> Python package released to pypi.org, e.g. <code>nomad-lab==1.3.0</code>.</li>
<li>a docker image tag, e.g. <code>gitlab-registry.mpcdf.mpg.de/nomad-lab/nomad-fair:v1.3.0</code></li>
<li>the docker image tag <code>stable</code> points to the image with the latest release tag</li>
</ul>
<h2 id="steps-towards-a-new-release">Steps towards a new release<a class="headerlink" href="#steps-towards-a-new-release" title="Permanent link">&para;</a></h2>
<ul>
<li>Silently create a new version tag in the <code>v1.3.0</code> format.</li>
<li>Deploy the build from this tag to the public NOMAD deployments.
What deployments are updated might depend on the current needs. But usually
the production and test deployment should be updated.</li>
<li>Release the Python package to the local gitlab registry. (This will update the
NORTH Jupyter image in the next nightly build and most likely effect plugins)</li>
<li>Bump the <code>latest</code> docker image tag.</li>
<li>For minor and major releases, encourage (Oasis) users to test the public services and the latest docker image for a short trial phase (e.g. 3 days). For patch releases this step should be
skipped.</li>
<li>Create a gitlab release from the tag with potential release notes. Those notes
should also be added to the README.md. It is ok, if the updated README.md is not part of the
release itself.</li>
<li>Bump the <code>stable</code> docker image tag.</li>
<li>Publish the Python package to <a href="https://pypi.org/">pypi.org</a></li>
</ul>
<h2 id="how-to-deal-with-hotfixes">How to deal with hotfixes<a class="headerlink" href="#how-to-deal-with-hotfixes" title="Permanent link">&para;</a></h2>
<p>This depends on the current <code>develop</code> branch and requires a judgement call. There are
two opposing scenarios:</p>
<ol>
<li>
<p>The <code>develop</code> branch only contains minor fixes or fix/features that are not likely to effect
the released functionality. In this case, a new release with an increased patch version
is the right call.</p>
</li>
<li>
<p>The <code>develop</code> branch adds major refactorings and commits that likely effect the
released functionality. In this case, a <code>v1.3.0-hotfix</code> branch should be created.
After adding commits with the hotfix, the release process can be applied to the
hotfix branch in order to create a <code>v1.3.1</code> release that only contains the hotfixes and
not the changes on develop. After the <code>v1.3.1</code> release, the <code>v1.3.0-hotfix</code> branch is merged
back into develop. Hotfix branches should not live longer than a week.</p>
</li>
</ol>
<h2 id="major-minor-patch-versions">Major, minor, patch versions<a class="headerlink" href="#major-minor-patch-versions" title="Permanent link">&para;</a></h2>
<ul>
<li>
<p><strong>patch</strong>: No significant refactorings. Only new/updated features behind disabled feature switches.
Bugfixes. Might mark features as deprecated.</p>
</li>
<li>
<p><strong>minor</strong>: Might enabled new features by default. Can contain major refactorings (especially if they effect to plugin developers, data stewards etc.). Might finally deprecate features.
Should "basically" be backwards compatible.</p>
</li>
<li>
<p><strong>major</strong>: Breaking changes and will require data migration.</p>
</li>
</ul>
<p>What is a <em>breaking change</em> and what does "basically" backwards compatible mean?
...
major vs minor. The following things would generally not be considered <em>breaking</em> and would be considered <em>backwards compatible</em>:</p>
<ul>
<li>the breaking change is for a feature that is not enabled by default</li>
<li>data migration is necessary for new functionality, but optional for existing functionality</li>
<li>it is unlikely that plugins not developed by FAIRmat are effected</li>
<li>it is unlikely that data beyond the central NOMAD deployments need to be migrated</li>
</ul>
<h2 id="release-schedule">Release schedule<a class="headerlink" href="#release-schedule" title="Permanent link">&para;</a></h2>
<p>Patch releases should happen frequently and at least once every other month. Also
...
schedule.</p>
<p>With a one <code>develop</code> branch Git strategy, there might be necessary exceptions to
...
put on hold for another month or two.</p>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="migrate-to-autoformatter.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Migrate to autoformatted code">
          ...
          <a href="../../examples/overview.html" class="md-footer__link md-footer__link--next" aria-label="Next: Overview">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
