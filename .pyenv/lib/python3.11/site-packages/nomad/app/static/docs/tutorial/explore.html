...
">
        ...
        <link rel="prev" href="upload_publish.html">
      
      
        <link rel="next" href="access_api.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Exploring data - Documentation</title>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item md-nav__item--active">
      ...
      <a href="explore.html" class="md-nav__link md-nav__link--active">
...
<p>This tutorial shows how to use NOMAD's search interface and structured data browsing to explore available data.</p>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="upload_publish.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Uploading and publishing data">
          ...
          <a href="access_api.html" class="md-footer__link md-footer__link--next" aria-label="Next: Access data via API">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
