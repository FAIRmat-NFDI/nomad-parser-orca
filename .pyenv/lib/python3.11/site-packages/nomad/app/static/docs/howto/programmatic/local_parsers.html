...
">
        ...
        <link rel="prev" href="archive_query.html">
      
      
        <link rel="next" href="../oasis/install.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Run a parser - Documentation</title>
   ...
   <link href="../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#how-to-run-a-parser" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    Run a parser
      ...
      <a href="local_parsers.html" class="md-nav__link md-nav__link--active">
  ...
  <a href="#from-the-command-line" class="md-nav__link">
    <span class="md-ellipsis">
      From the command line
        ...
        <li class="md-nav__item">
  <a href="#from-a-python-program" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="how-to-run-a-parser">How to run a parser<a class="headerlink" href="#how-to-run-a-parser" title="Permanent link">&para;</a></h1>
<p>You can find a <a href="../../reference/parsers.html">list of all parsers</a> and supported files in the reference.</p>
<p>First you need to have the <code>nomad-lab</code> pypi package installed. You find more detailed
instructions <a href="pythonlib.html">here</a>:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>pip install nomad-lab
</code></pre></div>
...
<p>You can run NOMAD parsers from the <a href="../../reference/cli.html">command line interface</a> (CLI).
The parse command will automatically match the right parser to your file and run the parser.
There are two output formats:</p>
<ul>
<li><code>--show-metadata</code> a json representation of the basic metadata</li>
<li><code>--show-archive</code> a json representation of the full parse results</li>
<li><code>--preview-plots</code>: Optionally previews the generated plots.</li>
<li><code>--save-plot-dir &lt;directory&gt;</code>: Specifies a directory to save the plot images.</li>
</ul>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a>nomad parse --show-archive &lt;path-to-your-mainfile-code-output-file&gt;
</code></pre></div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you run into missing dependency errors, you might want to install additional
dependencies via <code>pip install nomad-lab[parsing]</code>. Only a few parsers require
extra dependencies. Please refer to the parser projects for more details.</p>
</div>
<p>To skip the parser matching, i.e. the process that determined which parser fits to
the given file, and state the parser directly, you can use the <code>--parser</code> argument
to provide a <a href="../../reference/parsers.html">parser name</a>.</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a>nomad parse --parser parsers/vasp &lt;path-to-your-mainfile-code-output-file&gt;
</code></pre></div>
<p>To skip the potentially error-prone and depending on your use-case unnecessary
normalization, you can use the <code>--skip-normalizers</code> argument:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-3-1" name="__codelineno-3-1" href="#__codelineno-3-1"></a>nomad parse --skip-normalizers &lt;path-to-your-mainfile-code-output-file&gt;
</code></pre></div>
<h2 id="from-a-python-program">From a python program<a class="headerlink" href="#from-a-python-program" title="Permanent link">&para;</a></h2>
<p>You can also use the NOMAD parsers within Python, as shown below.
This will give you the parse results as metainfo objects to conveniently analyze the results in Python.
See metainfo for more details on how to use the metainfo in Python.</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-4-1" name="__codelineno-4-1" href="#__codelineno-4-1"></a><span class="c1"># requires: nomad-lab</span>
<a id="__codelineno-4-2" name="__codelineno-4-2" href="#__codelineno-4-2"></a><span class="kn">import</span> <span class="nn">sys</span>
<a id="__codelineno-4-3" name="__codelineno-4-3" href="#__codelineno-4-3"></a><span class="kn">from</span> <span class="nn">nomad.client</span> <span class="kn">import</span> <span class="n">parse</span><span class="p">,</span> <span class="n">normalize_all</span>
<a id="__codelineno-4-4" name="__codelineno-4-4" href="#__codelineno-4-4"></a>
<a id="__codelineno-4-5" name="__codelineno-4-5" href="#__codelineno-4-5"></a><span class="c1"># match and run the parser</span>
<a id="__codelineno-4-6" name="__codelineno-4-6" href="#__codelineno-4-6"></a><span class="n">archives</span> <span class="o">=</span> <span class="n">parse</span><span class="p">(</span><span class="s1">&#39;path/to/you/file&#39;</span><span class="p">)</span>
<a id="__codelineno-4-7" name="__codelineno-4-7" href="#__codelineno-4-7"></a><span class="c1"># run all normalizers</span>
<a id="__codelineno-4-8" name="__codelineno-4-8" href="#__codelineno-4-8"></a><span class="k">for</span> <span class="n">archive</span> <span class="ow">in</span> <span class="n">archives</span><span class="p">:</span>
<a id="__codelineno-4-9" name="__codelineno-4-9" href="#__codelineno-4-9"></a>    <span class="n">normalize_all</span><span class="p">(</span><span class="n">archive</span><span class="p">)</span>
<a id="__codelineno-4-10" name="__codelineno-4-10" href="#__codelineno-4-10"></a>
<a id="__codelineno-4-11" name="__codelineno-4-11" href="#__codelineno-4-11"></a>    <span class="c1"># get the &#39;main section&#39; section_run as a metainfo object</span>
<a id="__codelineno-4-12" name="__codelineno-4-12" href="#__codelineno-4-12"></a>    <span class="n">section_run</span> <span class="o">=</span> <span class="n">archive</span><span class="o">.</span><span class="n">run</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span>
<a id="__codelineno-4-13" name="__codelineno-4-13" href="#__codelineno-4-13"></a>
<a id="__codelineno-4-14" name="__codelineno-4-14" href="#__codelineno-4-14"></a>    <span class="c1"># get the same data as JSON serializable Python dict</span>
<a id="__codelineno-4-15" name="__codelineno-4-15" href="#__codelineno-4-15"></a>    <span class="n">python_dict</span> <span class="o">=</span> <span class="n">section_run</span><span class="o">.</span><span class="n">m_to_dict</span><span class="p">()</span>
</code></pre></div>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="archive_query.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Access processed data">
          ...
          <a href="../oasis/install.html" class="md-footer__link md-footer__link--next" aria-label="Next: Install an Oasis">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
