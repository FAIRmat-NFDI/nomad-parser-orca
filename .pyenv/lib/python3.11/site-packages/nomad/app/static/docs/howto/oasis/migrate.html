...
">
        ...
        <link rel="prev" href="plugins_install.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Migrate Oasis versions - Documentation</title>
   ...
   <link href="../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#how-to-migrate-oasis-versions" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="plugins_install.html" class="md-nav__link">
  ...
  <a href="#migration-steps" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Migration steps">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#to-122" class="md-nav__link">
    <span class="md-ellipsis">
      to 1.2.2
    </span>
  </a>
...
<h1 id="how-to-migrate-oasis-versions">How to migrate Oasis versions<a class="headerlink" href="#how-to-migrate-oasis-versions" title="Permanent link">&para;</a></h1>
...
<a href="https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/container_registry/36" target="_blank">public docker registry</a>.
...
<p>A road-map for major features can be found on our homepage <a href="https://nomad-lab.eu/nomad-lab/features.html" target="_blank">here</a>. You'll find a detailed change log in the source code <a href="https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/blob/develop/CHANGELOG.md" target="_blank">here</a>.</p>
...
<h3 id="to-122">to 1.2.2<a class="headerlink" href="#to-122" title="Permanent link">&para;</a></h3>
<p>We upgraded the Jupyterhub version used for NORTH from 1.0.2 to 4.0.2. By default the
Jupyterhub database is persisted in the <code>nomad_oasis_north</code> container. If you want to
keep the database (e.g. to not loose any open tools), you will have to upgrade the database.
Update the NOMAD docker image version and restart the Oasis like this:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a>docker compose down
<a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a>docker compose pull
<a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a>docker compose run north python -m jupyterhub upgrade-db
<a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a>docker compose up -d
</code></pre></div>
<p>Alternatively, you can delete the <code>nomad_oasis_north</code> container and start with a fresh
database. Make sure that all north tools are stopped and removed.</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a>docker compose down
<a id="__codelineno-2-2" name="__codelineno-2-2" href="#__codelineno-2-2"></a>docker rm nomad_oasis_north
<a id="__codelineno-2-3" name="__codelineno-2-3" href="#__codelineno-2-3"></a>docker compose pull
<a id="__codelineno-2-4" name="__codelineno-2-4" href="#__codelineno-2-4"></a>docker compose up -d
</code></pre></div>
...
<li>
<p>We changed the archive file format. <a href="admin.html#re-processing">Re-processing</a> might yield better performance.</p>
</li>
<li>
...
<a href="admin.html#re-processing">Re-processing</a> all data will enable this feature for old data. Any analysis build on
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-3-1" name="__codelineno-3-1" href="#__codelineno-3-1"></a>docker<span class="w"> </span>compose<span class="w"> </span>stop
<a id="__codelineno-3-2" name="__codelineno-3-2" href="#__codelineno-3-2"></a>docker<span class="w"> </span>compose<span class="w"> </span>rm<span class="w"> </span>-f
</code></pre></div></p>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-4-1" name="__codelineno-4-1" href="#__codelineno-4-1"></a>docker<span class="w"> </span>compose<span class="w"> </span>pull
<a id="__codelineno-4-2" name="__codelineno-4-2" href="#__codelineno-4-2"></a>docker<span class="w"> </span>compose<span class="w"> </span>up<span class="w"> </span>-d
</code></pre></div></p>
...
<div class="highlight"><pre><span></span><code><a id="__codelineno-5-1" name="__codelineno-5-1" href="#__codelineno-5-1"></a>docker<span class="w"> </span><span class="nb">exec</span><span class="w"> </span>-ti<span class="w"> </span>nomad_oasis_app<span class="w"> </span>bash<span class="w"> </span>-c<span class="w"> </span><span class="s1">&#39;nomad admin upgrade migrate-mongo --src-db-name nomad_v0_8&#39;</span>
<a id="__codelineno-5-2" name="__codelineno-5-2" href="#__codelineno-5-2"></a>docker<span class="w"> </span><span class="nb">exec</span><span class="w"> </span>-ti<span class="w"> </span>nomad_oasis_app<span class="w"> </span>bash<span class="w"> </span>-c<span class="w"> </span><span class="s1">&#39;nomad admin uploads reprocess&#39;</span>
</code></pre></div>
<p>Now all your data should appear in your OASIS again. If you like, you can remove the
old index and database:</p>
<div class="highlight"><pre><span></span><code><a id="__codelineno-6-1" name="__codelineno-6-1" href="#__codelineno-6-1"></a>docker<span class="w"> </span><span class="nb">exec</span><span class="w"> </span>nomad_oasis_elastic<span class="w"> </span>bash<span class="w"> </span>-c<span class="w"> </span><span class="s1">&#39;curl -X DELETE http://elastic:9200/nomad_fairdi&#39;</span>
<a id="__codelineno-6-2" name="__codelineno-6-2" href="#__codelineno-6-2"></a>docker<span class="w"> </span><span class="nb">exec</span><span class="w"> </span>nomad_oasis_mongo<span class="w"> </span>bash<span class="w"> </span>-c<span class="w"> </span><span class="s1">&#39;mongo nomad_fairdi --eval &quot;printjson(db.dropDatabase())&quot;&#39;</span>
</code></pre></div>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="plugins_install.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Install plugins">
          ...
          <a href="admin.html" class="md-footer__link md-footer__link--next" aria-label="Next: Perform admin tasks">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
