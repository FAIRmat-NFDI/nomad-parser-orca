...
">
        ...
        <link rel="prev" href="parser_plugins.html">
      
      
        <link rel="next" href="h5md_expl.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>H5MD schema - Howto - Documentation</title>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    H5MD schema - Howto
      ...
      <a href="h5md_howto.html" class="md-nav__link md-nav__link--active">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#observables-group" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Observables Group">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#configurational-observables" class="md-nav__link">
    <span class="md-ellipsis">
      Configurational Observables
          ...
          <li class="md-nav__item">
  <a href="#ensemble-average-observables" class="md-nav__link">
    <span class="md-ellipsis">
      Ensemble Average Observables
          ...
          <li class="md-nav__item">
  <a href="#time-correlation-observables" class="md-nav__link">
    <span class="md-ellipsis">
...
<p>The H5MD-NOMAD functionalities are still in the beta testing phase.
Please contact us with any issues or questions.</p>
</div>
...
<dl>
<dt><a href="https://docs.h5py.org/en/stable/quick.html">h5py</a></dt>
<dd>module for reading and writing HDF5 files.</dd>
<dt><a href="https://pint.readthedocs.io/en/0.10.1/tutorial.html">UnitRegistry</a></dt>
<dd>object from the <a href="https://pint.readthedocs.io/en/stable/">pint</a> package that provides assistance for working with units. We suggest using this package for easiest compatibility with NOMAD. If you have <code>nomad-lab</code> installed, you can alternatively import <code>ureg</code> with <code>from nomad.units import ureg</code>.</dd>
<dt><a href="https://www.mdanalysis.org/">MDAnalysis</a></dt>
<dd>a library to analyze trajectories from molecular dynamics simulations stored in various formats.</dd>
<dt><a href="https://parmed.github.io/ParmEd/html/index.html">ParmEd</a></dt>
<dd>a tool for aiding in investigations of biomolecular systems using popular molecular simulation packages.</dd>
</dl>
...
<h3 id="h5md-group"><a href="h5md_expl.html#the-h5md-group">H5MD Group</a><a class="headerlink" href="#h5md-group" title="Permanent link">&para;</a></h3>
...
<h3 id="particles-group"><a href="h5md_expl.html#the-particles-group">Particles Group</a><a class="headerlink" href="#particles-group" title="Permanent link">&para;</a></h3>
...
<h3 id="connectivity-group"><a href="h5md_expl.html#the-connectivity-group">Connectivity Group</a><a class="headerlink" href="#connectivity-group" title="Permanent link">&para;</a></h3>
...
<h3 id="observables-group"><a href="h5md_expl.html#the-observables-group">Observables Group</a><a class="headerlink" href="#observables-group" title="Permanent link">&para;</a></h3>
...
<h4 id="configurational-observables"><a href="h5md_expl.html#configurational_observable_anchor">Configurational Observables</a><a class="headerlink" href="#configurational-observables" title="Permanent link">&para;</a></h4>
<p>Fabricated data:
...
<h4 id="ensemble-average-observables"><a href="h5md_expl.html#ensemble_average_observable_anchor">Ensemble Average Observables</a><a class="headerlink" href="#ensemble-average-observables" title="Permanent link">&para;</a></h4>
...
<h4 id="time-correlation-observables"><a href="h5md_expl.html#time_correlation_observable_anchor">Time Correlation Observables</a><a class="headerlink" href="#time-correlation-observables" title="Permanent link">&para;</a></h4>
...
<h3 id="parameter-group"><a href="h5md_expl.html#the-parameters-group">Parameter Group</a><a class="headerlink" href="#parameter-group" title="Permanent link">&para;</a></h3>
<p>Using the json templates for <a href="h5md_expl.html#force_calculation_template_anchor">force calculations</a> and <a href="h5md_expl.html#md_workflow_template_anchor">molecular dynamics workflows</a>, the (meta)data can be written to the H5MD-NOMAD file using the following code:</p>
...
<p>It's as simple as that! Now, we can <a href="uploading.html#drag-and-drop-uploads">upload our H5MD-NOMAD file directly to NOMAD</a> and all the written (meta)data will be stored according to the standard NOMAD schema.</p>
...
<p>This page demonstrates how to create a "standard" topology in H5MD-NOMAD. The demonstrated organization of molecules and monomers is identical to what other NOMAD parsers do to create a topology from native simulation files (e.g., outputs from <a href="https://www.gromacs.org/">GROMACS</a> or <a href="https://www.lammps.org">LAMMPS</a>). However, the user is free to deviate from this standard to create arbitrary organizations of particles, as described in <a href="h5md_expl.html#the-connectivity-group">Connectivity</a>.</p>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="parser_plugins.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Parser plugins">
          ...
          <a href="h5md_expl.html" class="md-footer__link md-footer__link--next" aria-label="Next: H5MD schema - Explanation">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
