...
">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Writing Guide - Documentation</title>
   ...
   <link href="assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#writing-guide" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#images-and-data" class="md-nav__link">
    <span class="md-ellipsis">
      Images and Data
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#sections-hierarchy" class="md-nav__link">
    <span class="md-ellipsis">
      Sections Hierarchy
    </span>
  </a>
...
<h1 id="writing-guide">Writing Guide<a class="headerlink" href="#writing-guide" title="Permanent link">&para;</a></h1>
<p>This is a guide for best practices when contributing to the NOMAD documentation.</p>
<h2 id="images-and-data">Images and Data<a class="headerlink" href="#images-and-data" title="Permanent link">&para;</a></h2>
<p>All assets specific to an individual markdown file should be stored within an immediate sub-directory of the file, labeled accordingly. Please use <code>images/</code> and <code>data/</code> for the image and data files, respectively.</p>
<h2 id="sections-hierarchy">Sections Hierarchy<a class="headerlink" href="#sections-hierarchy" title="Permanent link">&para;</a></h2>
<p>single "#" sections should only be used at the beginning of the md file</p>
<h2 id="external-links">External Links<a class="headerlink" href="#external-links" title="Permanent link">&para;</a></h2>
<p>Use <a href="" target="_blank"></a> for external links to open a new browser window.</p>
<h2 id="admonitions">Admonitions<a class="headerlink" href="#admonitions" title="Permanent link">&para;</a></h2>
<p>Here is a list of currently used admonitions within the docs:</p>
<ul>
<li>
