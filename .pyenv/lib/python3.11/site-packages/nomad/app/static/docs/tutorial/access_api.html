...
">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Access data via API - Documentation</title>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item md-nav__item--active">
      ...
      <a href="access_api.html" class="md-nav__link md-nav__link--active">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <h1>Access data via API</h1>

<div class="admonition warning">
<p class="admonition-title">Attention</p>
<p>We are currently working to update this content.</p>
</div>
<p>This video tutorial explains the basics of API and shows how to do simple requests
against the NOMAD API.</p>
...
<a href="https://nomad-lab.eu/prod/v1/test/gui/search/entries">here</a>.</p>
</div>
<div class="youtube">
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="explore.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Exploring data">
          ...
          <a href="custom.html" class="md-footer__link md-footer__link--next" aria-label="Next: Schemas and plugins">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
