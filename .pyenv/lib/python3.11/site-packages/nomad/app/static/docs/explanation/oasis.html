...
">
        ...
        <link rel="next" href="../reference/config.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Why you need an Oasis - Documentation</title>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item md-nav__item--active">
      ...
      <a href="oasis.html" class="md-nav__link md-nav__link--active">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <h1>Why you need an Oasis</h1>

<p>The software that runs NOMAD is Open-Source and can be used independently of the NOMAD
<em>central installation</em> at <a href="http://nomad-lab.eu" target="_blank">http://nomad-lab.eu</a>.
We call any NOMAD installation that is not the <em>central</em> one a NOMAD Oasis.</p>
<figure>
<p><a class="glightbox" href="images/oasis-use-cases.png" data-type="image" data-width="auto" data-height="auto" data-desc-position="bottom"><img alt="oasis use-cases" src="images/oasis-use-cases.png" width="700" /></a>
  </p>
<figcaption>NOMAD Oasis use-cases</figcaption>
</figure>
<p>There are several use-cases how the NOMAD software could be used. Of course other
uses and hybrids are imaginable:</p>
<ul>
<li>Academia: Use the Oasis for local management of unpublished research data</li>
<li>Mirror: Use the Oasis as a mirror that hosts a copy of all published NOMAD data</li>
<li>Industry: Use of Oasis to manage private data and full internal use of published data in compliance with strict privacy policies</li>
<li>FAIRmat: Use Oasis to form a network of repositories to build a federated data infrastructure
for materials science.
This is what we do in the <a href="https://www.fair-di.eu/fairmat/consortium" target="_blank">FAIRmat project</a>.</li>
</ul>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="architecture.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Architecture">
          ...
          <a href="../reference/config.html" class="md-footer__link md-footer__link--next" aria-label="Next: Configuration">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
