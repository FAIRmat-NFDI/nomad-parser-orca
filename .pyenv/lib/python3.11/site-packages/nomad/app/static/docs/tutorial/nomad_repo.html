...
">
        ...
        <link rel="next" href="upload_publish.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Navigating to NOMAD - Documentation</title>
   ...
   <link href="../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#navigating-to-the-nomad-repository" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item md-nav__item--active">
      ...
      <a href="nomad_repo.html" class="md-nav__link md-nav__link--active">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="upload_publish.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="access_api.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="custom.html" class="md-nav__link">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item">
      <a href="develop_plugin.html" class="md-nav__link">
...
<h1 id="navigating-to-the-nomad-repository">Navigating to the NOMAD repository<a class="headerlink" href="#navigating-to-the-nomad-repository" title="Permanent link">&para;</a></h1>
<p>There are several access points to the NOMAD repository.
The general <a href="https://nomad-lab.eu/nomad-lab/" target="_blank"><em>landing page</em></a> will give you a quick rundown of NOMAD's usage and features, and provides several links to documentation, tutorials, and the history behind the project.</p>
<p>From this page, we can navigate to the NOMAD repository, where we can upload, manage, and explore data.
There are 2 public versions available:</p>
<ol>
<li><a href="https://nomad-lab.eu/prod/v1/gui/search/entries" target="_blank">stable</a>, which is accessed by clicking the "Open NOMAD" button at the top of the landing page (highlighted <span style="color:orange">orange</span> in images below).</li>
<li><a href="https://nomad-lab.eu/prod/v1/staging/gui/search/entries" target="_blank">beta /staging</a>, which has the latest release and updates much more frequently, but may also harbor unstable or untested features. You can navigate to this version via two distinct links: 1. at the bottom-right corner of the landing page and 2. under "SOLUTIONS" &gt; "NOMAD" &gt; "Try and Test" in the top navigation menu (highlighted <span style="color:red">red</span> in images below).</li>
</ol>
<div class="image-container">
<p><a class="glightbox" href="images/beta1.png" data-type="image" data-width="auto" data-height="auto" data-desc-position="bottom"><img alt="NOMAD Beta at the bottom of the website" class="screenshot" src="images/beta1.png" /></a>
<a class="glightbox" href="images/beta2.png" data-type="image" data-width="auto" data-height="auto" data-desc-position="bottom"><img alt="NOMAD Beta inside solutions" class="screenshot" src="images/beta2.png" /></a></p>
</div>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="upload_publish.html" class="md-footer__link md-footer__link--next" aria-label="Next: Uploading and publishing data">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
