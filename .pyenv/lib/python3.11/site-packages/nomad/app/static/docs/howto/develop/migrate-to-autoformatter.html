...
">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Migrate to autoformatted code - Documentation</title>
   ...
   <link href="../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#how-to-migrate-existing-merge-requests-to-auto-formatted-code" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    Migrate to autoformatted code
      ...
      <a href="migrate-to-autoformatter.html" class="md-nav__link md-nav__link--active">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#optional-step" class="md-nav__link">
    <span class="md-ellipsis">
      Optional step:
    </span>
  </a>
...
<h1 id="how-to-migrate-existing-merge-requests-to-auto-formatted-code">How to migrate existing merge requests to auto-formatted code<a class="headerlink" href="#how-to-migrate-existing-merge-requests-to-auto-formatted-code" title="Permanent link">&para;</a></h1>
<ol>
<li>Fetch the latest changes.</li>
</ol>
<div class="highlight"><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>git<span class="w"> </span>fetch
</code></pre></div>
<ol>
<li>Merge or rebase the changes before the auto-formatter commit. There might be conflicts at this stage, carefully review those changes and resolve the conflicts.</li>
</ol>
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a>git<span class="w"> </span>merge<span class="w"> </span>f4b6e09884bb2ea2f9af1129bd5e1bf8f9ef2ffc
</code></pre></div>
<ol>
<li>
<p>Install ruff.
<div class="highlight"><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a>pip<span class="w"> </span>install<span class="w"> </span><span class="nv">ruff</span><span class="o">==</span><span class="m">0</span>.1.8
</code></pre></div></p>
</li>
<li>
<p>Auto-format and commit your code.
<div class="highlight"><pre><span></span><code><a id="__codelineno-3-1" name="__codelineno-3-1" href="#__codelineno-3-1"></a>ruff<span class="w"> </span>format<span class="w"> </span>.<span class="w"> </span><span class="o">&amp;&amp;</span><span class="w"> </span>git<span class="w"> </span>commit<span class="w"> </span>-am<span class="w"> </span><span class="s2">&quot;autoformat&quot;</span>
</code></pre></div></p>
</li>
<li>
<p>Merge the formatted code. This shouldn't have any conflicts.
<div class="highlight"><pre><span></span><code><a id="__codelineno-4-1" name="__codelineno-4-1" href="#__codelineno-4-1"></a>git<span class="w"> </span>merge<span class="w"> </span>5d5879a4b4f12fec1ebd0d133684190810b6a838<span class="w"> </span>-X<span class="w"> </span>ours
</code></pre></div></p>
</li>
<li>
<p>Merge the develop branch. There might be conflicts at this stage, carefully review those changes and resolve the conflicts.
<div class="highlight"><pre><span></span><code><a id="__codelineno-5-1" name="__codelineno-5-1" href="#__codelineno-5-1"></a>git<span class="w"> </span>merge<span class="w"> </span>develop
</code></pre></div></p>
</li>
</ol>
<h2 id="optional-step">Optional step:<a class="headerlink" href="#optional-step" title="Permanent link">&para;</a></h2>
<ol>
<li>Configure your git blame to ignore the formatting changes.
<div class="highlight"><pre><span></span><code><a id="__codelineno-6-1" name="__codelineno-6-1" href="#__codelineno-6-1"></a>git<span class="w"> </span>config<span class="w"> </span>blame.ignoreRevsFile<span class="w"> </span>.git-blame-ignore-revs
</code></pre></div></li>
</ol>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="search.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Extend the search">
          ...
          <a href="release.html" class="md-footer__link md-footer__link--next" aria-label="Next: Make a release">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
