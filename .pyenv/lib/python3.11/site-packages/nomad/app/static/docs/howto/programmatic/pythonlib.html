...
">
        ...
        <link rel="prev" href="publish_python.html">
      
      
        <link rel="next" href="archive_query.html">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-9.5.33">
        ...
        <title>Install nomad-lab - Documentation</title>
   ...
   <link href="../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#how-to-install-nomad-lab" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    ...
    <li class="md-nav__item md-nav__item--active">
      ...
      <a href="pythonlib.html" class="md-nav__link md-nav__link--active">
...
<h1 id="how-to-install-nomad-lab">How to install nomad-lab<a class="headerlink" href="#how-to-install-nomad-lab" title="Permanent link">&para;</a></h1>
<p>We provide a Python package called <code>nomad-lab</code>. The package can be used to run
certain NOMAD features within local Python programming environments. It includes
the NOMAD parsers and normalizers, or convenience functions to query the processed data on NOMAD.</p>
<p>Released version of the package are hosted on <a href="https://pypi.org/project/nomad-lab/" target="_blank">pypi</a>
and you can install it with <em>pip</em> (or conda).</p>
<p>To install the newest pypi release, simply use pip:
...
<p>The latest develop versions might still be considered beta and might not be published to
pypi. If you require specific new features you might need to install <code>nomad-lab</code>
from our GitLab package registry. To use features of a specific commit or
branch, consider to <a href="../develop/setup.html">clone and build the project</a> yourself.</p>
</div>
<p>To install the latest release developer releases from our GitLab use:
<div class="highlight"><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a>pip install nomad-lab --extra-index-url https://gitlab.mpcdf.mpg.de/api/v4/projects/2187/packages/pypi/simple
</code></pre></div></p>
<p>To install an older version of NOMAD (e.g. v0.10.x), you can of use reference
the respective version on pypy:
<div class="highlight"><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a>pip install nomad-lab==1.0.10
</code></pre></div></p>
<p>Certain functionality might require more dependencies. The basic install above,
installs the dependencies for accessing the NOMAD Archive or running most of the NOMAD
parsers.</p>
<p>Other functions, e.g. running the NOMAD infrastructure, require additional dependencies.
You can use the <code>[extra]</code> notation to install these extra requirements:</p>
<p><div class="highlight"><pre><span></span><code><a id="__codelineno-3-1" name="__codelineno-3-1" href="#__codelineno-3-1"></a>pip install nomad-lab[parsing]
<a id="__codelineno-3-2" name="__codelineno-3-2" href="#__codelineno-3-2"></a>pip install nomad-lab[infrastructure]
<a id="__codelineno-3-3" name="__codelineno-3-3" href="#__codelineno-3-3"></a>pip install nomad-lab[dev]
</code></pre></div>
The various extras have the following meaning:</p>
<ul>
<li><em>parsing</em>, run all parsers, incl. parsers based on HDF5, netCDF, or asr</li>
<li><em>infrastructure</em>, everything to run NOMAD services, see also
<a href="../oasis/install.html#base-linux-without-docker">Oasis documentation</a></li>
<li><em>dev</em>, necessary to run development and build tools, e.g. pytest, pylint, mypy</li>
</ul>
...
<script>var target=document.getElementById(location.hash.slice(1));target&&target.name&&(target.checked=target.name.startsWith("__tabbed_"))</script>
  ...
  Back to top
      ...
      <nav class="md-footer__inner md-grid" aria-label="Footer" >
          ...
          <a href="publish_python.html" class="md-footer__link md-footer__link--prev" aria-label="Previous: Publish data using python">
          ...
          <a href="archive_query.html" class="md-footer__link md-footer__link--next" aria-label="Next: Access processed data">
            <div class="md-footer__title">
              <span class="md-footer__direction">
                Next
              </span>
